...
/*
 * Documentation:
 * Select — https://app.subframe.com/0d6c855193c0/library?component=Select_bb88f90b-8c43-4b73-9c2f-3558ce7838f3
 */
  ...
  function ItemText(
    ...
    return children ? (
      <SubframeCore.Select.ItemText {...otherProps}>
        <span
          className={SubframeUtils.twClassNames(
            "text-body font-body text-primary-text",
            className
          )}
          ref={ref}
        >
    ...
    return (
      <SubframeCore.Select.Trigger asChild={true} {...otherProps}>
        ...
        >
          ...
          <FeatherChevronDown className="text-body font-body text-secondary-text" />
        </button>
...
>(function TriggerValue(
  ...
  return (
    <SubframeCore.Select.Value
      className={SubframeUtils.twClassNames(
        "w-full whitespace-nowrap text-body font-body text-primary-text",
        className
      )}
      ref={ref}
    ...
    return (
      ...
      >
        ...
        >
          ...
          <div
            className={SubframeUtils.twClassNames(
              "flex h-8 w-full flex-none flex-col items-start rounded-md border border-solid border-neutral-border bg-primary-background group-focus-within/bb88f90b:border group-focus-within/bb88f90b:border-solid group-focus-within/bb88f90b:border-brand-600",
              {
