...
/*
 * Documentation:
 * Tabs — https://app.subframe.com/0d6c855193c0/library?component=Tabs_e1ad5091-8ad8-4319-b1f7-3e47f0256c20
 */
    ...
    >
      {icon ? (
        <SubframeCore.IconWrapper
          className={SubframeUtils.twClassNames(
            "text-body font-body text-secondary-text group-hover/d5612535:text-primary-text",
            {
      ...
      {children ? (
        <span
          className={SubframeUtils.twClassNames(
            "text-body-bold font-body-bold text-secondary-text group-hover/d5612535:text-primary-text",
            {
              "text-neutral-400 group-hover/d5612535:text-neutral-400":
                disabled,
              "text-brand-700 group-hover/d5612535:text-brand-700": active,
