    ...
    >
      ...
      >
        ...
        >
          {stepNumber ? (
            <span
              className={SubframeUtils.twClassNames(
                "text-body-bold font-body-bold text-secondary-text text-center",
                {
      ...
      >
        {label ? (
          <span
            className={SubframeUtils.twClassNames(
              "line-clamp-2 w-full text-body font-body text-secondary-text",
              {
                "text-body-bold font-body-bold text-primary-text":
                  variant === "active",
                "text-primary-text": variant === "completed",
              }
            )}
          >
            {label}
